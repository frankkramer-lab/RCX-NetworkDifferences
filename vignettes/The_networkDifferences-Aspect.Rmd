...
* The `NetworkDifferences` aspect tracks the differences of two networks represented as RCX-objects. The `compareNetworks`-function returns an RCX-object whereby the nodes, nodeAttributes, edges, and edgeAttributes are a combination of the two given RCX `left` and `right`. This RCX-object has an networkDifferences-aspect, too, which is a list containing five dataframes to monitor the differences regarding the nodes, nodeAttributes, edges, edgeAttributes, and networkAttributes.
