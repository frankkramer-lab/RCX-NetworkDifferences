---
title: "04. The NetworkDifferences-Aspect"
author: 
...
The networkDifferences-aspect is a custom aspect to track and visualize the differences of two RCX-objects regarding the nodes, nodeAttributes, edges, edgeAttributes, and networkAttributes.
```{r library, echo=FALSE, message=FALSE}
library("RCX")
```
First of all, two RCX-networks `left` and `right` are created that will be used as examples later.
```{r left, tidy=FALSE}
left <- createRCX(
    nodes = createNodes(
        id=0:2, 
