...
represented as RCX-objects. First, two RCX-objects `left` and `right`
are created that will be used as examples later.
...
```
    ...
    ## $aspectClasses
    ##                        rcx                   metaData                      nodes                      edges             nodeAttributes 
    ##                      "RCX"           "MetaDataAspect"              "NodesAspect"              "EdgesAspect"     "NodeAttributesAspect" 
    ##             edgeAttributes          networkAttributes            cartesianLayout                   cyGroups         cyVisualProperties 
    ##     "EdgeAttributesAspect"  "NetworkAttributesAspect"    "CartesianLayoutAspect"           "CyGroupsAspect" "CyVisualPropertiesAspect" 
    ##         cyHiddenAttributes         cyNetworkRelations              cySubNetworks              cyTableColumn 
    ## "CyHiddenAttributesAspect" "CyNetworkRelationsAspect"      "CySubNetworksAspect"      "CyTableColumnAspect" 
    ## 
    ## $extensions
...
```
    ...
    ##  [1] Rcpp_1.0.9      digest_0.6.31   plyr_1.8.8      jsonlite_1.8.4  lifecycle_1.0.3 formatR_1.13    magrittr_2.0.3 
    ##  [8] evaluate_0.19   rlang_1.0.6     stringi_1.7.12  cli_3.6.0       rstudioapi_0.14 vctrs_0.5.1     rmarkdown_2.19 
    ## [15] tools_4.2.2     glue_1.6.2      xfun_0.36       yaml_2.3.6      fastmap_1.1.0   compiler_4.2.2  htmltools_0.5.4
    ## [22] knitr_1.41
