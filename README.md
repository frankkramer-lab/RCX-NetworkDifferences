...
style="width:100.0%"
alt="Node-centered RCX-object with matchByName TRUE" />
...
style="width:100.0%"
alt="Node-centered RCX-object with matchByName FALSE" />
<figcaption aria-hidden="true">Node-centered RCX-object with matchByName
FALSE</figcaption>
</figure>

The last figure shows the results if `matchByName` and
`includeNamesAndRepresents`are `TRUE`.
...
style="width:100.0%"
alt="Edge-centered RCX-object with matchByName TRUE" />
...
matchByName TRUE and the visualization of the node- and
edgeAtrributes</figcaption>
</figure>
